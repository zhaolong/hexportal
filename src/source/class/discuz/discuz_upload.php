...
if(file_exists(dirname(__FILE__).'/../../plugin/oss4dz/lib/sdk.class.php'))require_once(dirname(__FILE__).'/../../plugin/oss4dz/lib/sdk.class.php');
...
Class discuz_upload{
	...
	function save_to_local($source, $target) {
		...
		$this->obj = new ALIOSS($_G['cache']['plugin']['oss4dz']['key'],$_G['cache']['plugin']['oss4dz']['secret']);
		$this->obj->set_debug_mode(FALSE);
		...
		$response = $this->obj->upload_file_by_content($_G['cache']['plugin']['oss4dz']['bucket'],$object,$upload_file_options);
