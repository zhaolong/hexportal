...
<a title="未设置同步至QQ空间" class="syn_qq" href="javascript:void(0);" id="connectPost_synQQ_infloat" rel="connect_publish_feed_infloat">QQ空间</a>
...
c.style.display = 'block';
r.parentNode.insertBefore(c, r.nextSibling);
c.innerHTML = '<a href="javascript:void(0);" title="关闭同步发帖提示" class="d y" onclick="connect_syn_tip_hide_infloat();">close</a>此主题将同步到QQ空间和腾讯微博，您的好友或听众能够看到您发表的主题。&nbsp;&nbsp;<a class="xi2" href="javascript:void(0);" onclick="connect_syn_cancel_infloat();" title="取消发表主题时同步到QQ空间和腾讯微博，将来您可以到“设置-QQ绑定”页面重新设置。"><strong>暂不同步</strong></a>';
}
...
<a href="javascript:void(0);" ref="{$_G['connect']['qzone_share_url']}" id="k_qqshare" title="QQ空间"><i><img src="{$__IMGDIR}/qzone.gif" alt="QQ空间" />QQ空间</i></a>
...
<a href="javascript:void(0);" ref="{$_G['connect']['pengyou_share_url']}" id="k_pengyoushare" title="腾讯朋友"><i><img src="{$__IMGDIR}/pengyou.png" alt="腾讯朋友" />腾讯朋友</i></a>
<script type="text/javascript">
var _is_oauth_user = 
EOF;
 if($_G['member']['conuinsecret']) { 
...
<p>
<label for="use_qzone_avatar"><input type="checkbox" name="use_qzone_avatar" id="use_qzone_avatar" class="pc" value="1" checked="checked" tabindex="1" /> 使用QQ头像</label>
&nbsp;
<label for="use_qqshow"><input type="checkbox" name="use_qqshow" id="use_qqshow" class="pc" value="1" checked="checked" tabindex="1" /> <span title="QQ秀将展示在论坛帖子左侧和个人空间首页">使用QQ秀形象</span></label>
</p>
</td>
</tr>
</table>
...
<div class="bm_h bbs">
<h3 class="xs2">绑定已有帐号</h3>
</div>
<div class="rfm" id="connect_member_loginbind_tip">
<table>
<tr>
<th><img src="{$__IMGDIR}/connect_qq.gif" alt="QQ" class="mtn" /></th>
<td>绑定已有帐号可使用QQ帐号快速登录本站</td>
</tr>
</table>
</div>

EOF;
 } elseif($_G['setting']['regconnect']) { 
$js2 .= <<<EOF
