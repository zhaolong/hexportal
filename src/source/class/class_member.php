							...
							showmessage('location_login_succeed', $location, array(),
								array(
									...
									'extrajs' => '<script type="text/javascript">'.
										'setTimeout("window.location.href =\''."./plugin.php?id=host:host".'\';", 2000);'.
										'jQuery(\'#succeedmessage_href\').href = \''.$href.'\';'.
										'jQuery(\'#main_message\').hide();'.
										'jQuery(\'#main_succeed\').show();'.
										'jQuery(\'#succeedlocation\').html(\''.lang('message', $loginmessage, $param).'\');</script>'.$ucsynlogin,
									'striptags' => false,
									'showdialog' => true
								)
							);
	...
	function on_register() {
		...
		if(!submitcheck('regsubmit', 0, $seccodecheck, $secqaacheck)) {
			...
			$extra = array(
				'showid' => 'succeedmessage',
				'extrajs' => '<script type="text/javascript">'.
					'setTimeout("window.location.href =\''."./plugin.php?id=host:host".'\';", '.$refreshtime.');'.
					'jQuery(\'#succeedmessage_href\').href = \''.$href.'\';'.
					'jQuery(\'#main_message\').hide();'.
					'jQuery(\'#main_succeed\').show();'.
					'jQuery(\'#succeedlocation\').html(\''.lang('message', $locationmessage).'\');'.
				'</script>',
				'striptags' => false,
			);
